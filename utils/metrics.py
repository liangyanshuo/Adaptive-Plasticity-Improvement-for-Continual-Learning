...
def confusion_matrix(result_t, result_a, log_dir, fname=None, stronger_result_a=None):
    ...
    if fname is not None:
        ...
        print('', file=f)
        if stronger_result_a != None:
            print(' '.join(['%.4f' % r for r in stronger_result_a]), file=f)
