...
CSUPER='--dataset cifar100_superclass --data_path /home/liangys/data --pc_valid 0.05 --batch_size 64 --test_batch_size 64 --n_epochs 50 --cuda --earlystop'
FIVED='--dataset five_datasets --samples_per_task -1 --data_path /home/liangys/data --n_tasks 5 --pc_valid 0.05 --batch_size 64 --test_batch_size 64 --n_epochs 100 --cuda --earlystop --lr_min 1e-3 --lr_patience 5 --lr_factor 3'
...
# five datasets
CUDA_VISIBLE_DEVICES=$2 python main_api_cifarsup.py $FIVED --n_runs $n_runs --data_path $1 --model api --lr 0.1 --model_arch resnet --model_size 1.0 --expt_name api --cuda_enabled 1 --alpha 10 --step 0.5
