...
#             if args.model in ['api']:
#                 model.expand_feature_space(args, xtrain, writer=writer)
#             else:
...
#         elif args.model in ['dualgpm', 'api']:
#             # Threshold Update
#             model.update_threshold(i)
...
#                 elif args.model_size == 0.5:
#                     # ipdb.set_trace()
#                     param_memory += (model.net.conv1.weight.size(1) - 3)*32*16
#                     param_memory += (model.net.conv2.weight.size(1) - 32)*64*9
#                     param_memory += (model.net.conv3.weight.size(1) - 64)*128*4
#                     param_memory += (model.net.fc1.weight.size(1) - 512)*1024
#                     param_memory += (model.net.fc2.weight.size(1) - 1024)*1024
#                 else:
#                     raise NotImplementedError
...
#                 elif args.model_size == 0.5:
#                     param_memory += (model.net.conv1.weight.size(1) - 3)*10*25
#                     param_memory += (model.net.conv2.weight.size(1) - 10)*25*25
#                     param_memory += (model.net.fc1.weight.size(1) - 1600)*400
#                     param_memory += (model.net.fc2.weight.size(1) - 400)*250
#                 else:
#                     raise NotImplementedError
...
#                         # ipdb.set_trace()
#                         param_memory += (model.net.conv1.weight.size(1) - 3)*3
#                         param_memory += (model.net.conv2.weight.size(1) - 32)*32
#                         param_memory += (model.net.conv3.weight.size(1) - 64)*64
#                         param_memory += (model.net.fc1.weight.size(1) - 512)*512
#                         param_memory += (model.net.fc2.weight.size(1) - 1024)*1024
#                     else:
#                         raise NotImplementedError
#                 elif args.model_arch == 'lenet':
...
#                     elif args.model_size == 0.5:
#                         param_memory += (model.net.conv1.weight.size(1) - 3)*3
#                         param_memory += (model.net.conv2.weight.size(1) - 10)*10
#                         param_memory += (model.net.fc1.weight.size(1) - 1600)*1600
#                         param_memory += (model.net.fc2.weight.size(1) - 400)*400
#                     else:
#                         raise NotImplementedError
#                 elif args.model_arch == 'resnet':
#                     param_memory += (model.net.conv1.weight.size(1)-3)*3
...
#     if args.model in ['gpm', 'dualgpm', 'api']:
#         param_space = 0
#         # ipdb.set_trace()
#         for p in range(len(model.feature_list)):
...
#                 elif args.model_size == 0.5:
#                     # ipdb.set_trace()
#                     memory_space += (model.net.conv1.weight.size(1) - 3)*32*16
#                     memory_space += (model.net.conv2.weight.size(1) - 32)*64*9
#                     memory_space += (model.net.conv3.weight.size(1) - 64)*128*4
#                     memory_space += (model.net.fc1.weight.size(1) - 512)*1024
#                     memory_space += (model.net.fc2.weight.size(1) - 1024)*1024
#                 else:
#                     raise NotImplementedError
#             elif args.model_arch == 'lenet':
#                 if args.model_size == 1.0:
...
#                 elif args.model_size == 0.5:
#                     memory_space += (model.net.conv1.weight.size(1) - 3)*10*25
#                     memory_space += (model.net.conv2.weight.size(1) - 10)*25*25
#                     memory_space += (model.net.fc1.weight.size(1) - 1600)*400
#                     memory_space += (model.net.fc2.weight.size(1) - 400)*250
#                 else:
#                     raise NotImplementedError
#             elif args.model_arch == 'resnet':
...
#                     # ipdb.set_trace()
#                     memory_space += (model.net.conv1.weight.size(1) - 3)*3
#                     memory_space += (model.net.conv2.weight.size(1) - 32)*32
#                     memory_space += (model.net.conv3.weight.size(1) - 64)*64
#                     memory_space += (model.net.fc1.weight.size(1) - 512)*512
#                     memory_space += (model.net.fc2.weight.size(1) - 1024)*1024
#                 else:
#                     raise NotImplementedError
#             elif args.model_arch == 'lenet':
...
#                 elif args.model_size == 0.5:
#                     memory_space += (model.net.conv1.weight.size(1) - 3)*3
#                     memory_space += (model.net.conv2.weight.size(1) - 10)*10
#                     memory_space += (model.net.fc1.weight.size(1) - 1600)*1600
#                     memory_space += (model.net.fc2.weight.size(1) - 400)*400
#                 else:
#                     raise NotImplementedError
#             elif args.model_arch == 'resnet':
#                 memory_space += (model.net.conv1.weight.size(1)-3)*3
...
#     if args.model in ['api']:
#         path = os.path.join('Results', 'enabled_{}/dataset_{}/arch_{}/size_{}/method_{}/step_{}_alpha_{}'.format(args.cuda_enabled, args.dataset, args.model_arch, args.model_size, args.model, args.step, args.alpha))
#     else:
#         raise NotImplementedError
#     args.path = path
