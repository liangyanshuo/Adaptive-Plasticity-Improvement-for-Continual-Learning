...
def eval(model, x, y, t, args, stage=1):
    model.net.eval()
...
def life_experience(model, data, ids, args, logger):
    ...
    for i, t in enumerate(ids):
        ...
        if i > 0:
            ...
            for ep in prog_bar:
                ...
                for bi in range(0, len(idx), args.batch_size):
                    ...
                    v_x = xtrain[pos]
                    v_y = ytrain[pos]
                    loss = model.observe(v_x, v_y, t, writer)
                ...
                if args.earlystop:
                    # Valid
                    valid_loss, valid_acc = eval(model, xvalid, yvalid, t, args, stage=0)
        ...
        elif args.model in ['gpm', 'bn_gpm', 'trgp']:
            # Threshold Update
...
if __name__ == "__main__":
    ...
    if args.model_arch == 'lenet' or args.model_arch == 'alexnet':
        assert 'cifar' in args.dataset
    elif args.model_arch == 'pc_cnn':
        assert args.dataset == 'tinyimagenet'
    elif args.model_arch == 'resnet':
        assert args.dataset == 'five_datasets' or args.dataset == 'mini_imagenet'
