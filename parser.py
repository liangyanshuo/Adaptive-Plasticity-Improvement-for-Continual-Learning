...
def get_parser():
    ...
    parser.add_argument('--model', default='gpm', type=str, required=True, choices=['gpm', 'dualgpm', 'api', 'api_increase'], help='')
    ...
    parser.add_argument('--n_runs', type = int, default=0, help='')
    parser.add_argument('--cuda_enabled', type = int, default=0, help='')
    ...
    parser.add_argument("--dataset", default='mnist_permutations', type=str, required=True,
                        choices=['cifar100_20', 'cifar100_superclass', 'five_datasets', 'mini_imagenet'],
    ...
    parser.add_argument('--step', type = float, default=0.0, help='')
    parser.add_argument('--model_size', type = float, default=1.0, help='')
    parser.add_argument('--model_arch', type = str, default='mlp', help='')

    parser.add_argument('--alpha', type=float, default=1.0)

    # TRGP
    parser.add_argument('--Ours', default=False, action='store_true', help='')

    parser.add_argument('--layer', type = int, default=0, help='')
    ...
    # HAT
    parser.add_argument('--smax', type=float, default=400)

    parser.add_argument('--increase_rank', default=False, action='store_true', help='')
